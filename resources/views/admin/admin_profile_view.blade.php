								...
								<div class="card">
                                    ...
                                    <div class="row mb-3">
										...
										<div class="row mb-3">
											...
											<div class="col-sm-9 text-secondary">
												<input type="text" name="email" class="form-control" value="{{$adminData->email}}" disabled />
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-sm-3">
											...
											<div class="col-sm-9 text-secondary">
												<input type="text" name="phone" placeholder="+258" class="form-control" value="{{$adminData->phone}}" />
											</div>
										</div>
