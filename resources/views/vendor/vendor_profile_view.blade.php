								...
								<div class="card">
                                    ...
                                    <div class="row mb-3">
										...
										<div class="row mb-3">
											...
											<div class="col-sm-9 text-secondary">
												<input type="text" name="email" class="form-control" value="{{$vendorData->email}}" disabled />
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-sm-3">
											...
											<div class="col-sm-9 text-secondary">
												<input type="text" name="phone" placeholder="+258" class="form-control" value="{{$vendorData->phone}}" />
											</div>
										</div>
                                        ...
                                        <div class="row mb-3">
											...
											<div class="col-sm-9 text-secondary">
                                            <textarea class="form-control" id="inputAddress" name="vendor_short_info" placeholder="Coloque aqui sua informacao.." rows="3">{{$vendorData->vendor_short_info}}</textarea>											</div>
										</div>
