...
<div class="page-content">
    ...
    <div class="card">
        <div class="card-body p-4">
            ...
            <form method="post" id="myForm" action="{{route('update.product')}}" enctype="multipart/form-data">
            @csrf
        ...
        <input type="hidden" name="old_img" value="{{$products->id}}">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        {{ $products->getFirstMedia('cover')?->img()?->attributes(["style" =>'width:200px; height:150px;  margin-right: 10px; border-radius: 4px; border: 1px solid #ddd;']) }}	
