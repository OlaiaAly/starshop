							...
							<div class="col-lg-10">
                                ...
                                <input type="hidden" name ="id" value="{{$slider->id}}">
									<div class="card-body">
                                        ...
                                        <div class="row mb-3">
											<div class="col-sm-3">
												<h6 class="mb-0">Subtitulo Do Slide</h6>
											</div>
											<div class=" form-group col-sm-9 text-secondary">
                                        ...
                                        <div class="row mb-3">
											...
											<div class=" col-sm-9 text-secondary">
												<input type="file" name="slider_image" class="form-control" id="image" value=""/>
											</div>
										</div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            {{ $slider->getFirstMedia('slider')?->img()?->attributes(["style" =>'width:120px; height:120px;  margin-right: 10px; border-radius: 4px; border: 1px solid #ddd;']) }}	
											</div>
										</div>
