...
<h4>Conta  <span class="text-success">Activa</span></h4>
@else
<h4>Conta  <span class="text-danger">Desactivada</span></h4>
<p class="text-danger"><b>Espere pelo Admin activar a conta</b></p>
