        ...
        <div class="page-header breadcrumb-wrap">
            <div class="container">
                <div class="breadcrumb">
                    ...
                    <span></span>{{$vendor->name}} <span></span> Detalhes Do Artista
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-4-5">
                    <div class="shop-product-fillter">
                        <div class="totall-product">
                            <p>Temos <strong class="text-brand">{{count($vendor_product)}}</strong> para voce!</p>
                        </div>
...
@endif                                        <!-- <img src="{{ $product->getFirstMedia('cover') }}" style="width:5000px; height:5000px;" alt="Imagem do Produto"> -->
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <div>
                                            ...
                                            @else
                                            <span class="font-small text-muted">Por <a href="{{route('vendor.details', $vendor->id)}}">{{$product['vendor']['name']}}</a></span>
                        ...
                        <div class="vendor-info">
                            ...
                            <div class="vendor-info">
                                <ul class="font-sm mb-20">
                                    ...
                                    <li><img class="mr-5" src="{{asset('frontend/assets/imgs/theme/icons/icon-contact.svg')}}" alt="" /><strong>Call Us:</strong><span>(+258) {{$vendor->phone}}</span></li>
                                </ul>
