        ...
        <div class="page-header breadcrumb-wrap">
            <div class="container">
                <div class="breadcrumb">
                    ...
                    <span></span> <a href="shop-grid-right.html">{{ isset($product['category']['category_name']) ? $product['category']['category_name'] : 'Não informado' }}
                    </a> <span></span> {{ isset($product['subcategory']['subcategory_name']) ? $product['subcategory']['subcategory_name'] : 'Não informado' }}<span></span>{{$product->product_name}}
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 mb-md-0 mb-sm-5">
                                <div class="detail-gallery">
                                            ...
                                            @if($product->getMedia('products')->isNotEmpty())
                                                @foreach($product->getMedia('products') as $media)
                                                    <figure class="border-radius-10">
                                                        <img src="{{ $media->getUrl() }}" alt="Imagem do Produto" style="width:900px; height:550px;">
                                                    </figure>
                                                @endforeach
                                            @else
                                                <figure class="border-radius-10">
                                                    <img src="{{ asset('upload/no_image.jpg') }}" alt="Imagem Padrão" style="width:900px; height:550px;">
                                                </figure>
                                            @endif
                                    ...
                                    <div class="slider-nav-thumbnails">
                                        @foreach($product->getMedia('products') as $media)
                                            <div> 
                                                <img src="{{ $media->getUrl() }}" alt="Imagem do Produto" style="width:100px; height:100px;">
                                            </div>
                                        @endforeach
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="detail-info pr-30 pl-30">
                                    ...
                                    @php
                                        ...
                                        @if($product->discount_price === NULL || $product->discount_price == 0)                                        <div class="product-price primary-color float-left">
...
<ul class="mr-50 float-start">
    ...
    <ul class="float-start">
        ...
        <li>Estoque:<span class="in-stock text-brand ml-5">{{$product->product_qty}} item no estoque</span></li>
    </ul>
</div>
                                </div>
                                <!-- Detail Info -->
    ...
    @endif
                                        ...
                                        <ul class="contact-infor mb-50">
                                            <li><img src="{{asset('frontend/assets/imgs/theme/icons/icon-location.svg')}}" alt="" /><strong>Enderenco: </strong> <span>Proprietario</span></li>
                                            <li><img src="{{asset('frontend/assets/imgs/theme/icons/icon-contact.svg')}}" alt="" /><strong>Contacto:</strong><span>Proprietario</span></li>
                                        </ul>
                                            @else
                                            <ul class="contact-infor mb-50">
                                            <li><img src="{{asset('frontend/assets/imgs/theme/icons/icon-location.svg')}}" alt="" /><strong>Enderenco: </strong> <span></span></li>
                                            <li><img src="{{asset('frontend/assets/imgs/theme/icons/icon-contact.svg')}}" alt="" /><strong>Contacto:</strong><span></span></li>
                                        </ul>
                                            @endif
