            ...
            <div class="row">
                <div class="col-lg-8 mb-40">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <h6 class="text-body"><a href="<?php echo e(route('clear-cart', $cart->id)); ?>" class="text-muted"><i class="fi-rs-trash mr-5"></i>Clear Cart</a></h6>
                    </div>
                </div>
            </div>
            <div class="row">
                        ...
                        <table class="table table-wishlist">
                            ...
                            <tbody>
                                ...
                                <tr class="pt-30">
                                    ...
                                    <td class="text-center detail-info" data-title="Stock">
                                        <div class="detail-extralink mr-15">
                                            <div class="detail-qty border radius">
                                                ...
                                                <input type="text" name="quantity" class="qty-val" value="<?php echo e($cartItem->quantity); ?>" min="1">
                                    ...
                                    <td class="action text-center" data-title="Remove"><a href="<?php echo e(route('deleteItem', $cartItem->id)); ?>" class="text-body"><i class="fi-rs-trash"></i></a></td>
                                </tr>
