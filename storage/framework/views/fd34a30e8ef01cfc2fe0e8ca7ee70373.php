        ...
        <div class="page-header breadcrumb-wrap">
            <div class="container">
                <div class="breadcrumb">
                    ...
                    <span></span> <a href="shop-grid-right.html"><?php echo e(isset($product['category']['category_name']) ? $product['category']['category_name'] : 'Não informado'); ?>

                    </a> <span></span> <?php echo e(isset($product['subcategory']['subcategory_name']) ? $product['subcategory']['subcategory_name'] : 'Não informado'); ?><span></span><?php echo e($product->product_name); ?>
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 mb-md-0 mb-sm-5">
                                <div class="detail-gallery">
                                            ...
                                            <?php if($product->getMedia('products')->isNotEmpty()): ?>
                                                <?php $__currentLoopData = $product->getMedia('products'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $media): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <figure class="border-radius-10">
                                                        <img src="<?php echo e($media->getUrl()); ?>" alt="Imagem do Produto" style="width:900px; height:550px;">
                                                    </figure>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php else: ?>
                                                <figure class="border-radius-10">
                                                    <img src="<?php echo e(asset('upload/no_image.jpg')); ?>" alt="Imagem Padrão" style="width:900px; height:550px;">
                                                </figure>
                                            <?php endif; ?>
                                    ...
                                    <div class="slider-nav-thumbnails">
                                        <?php $__currentLoopData = $product->getMedia('products'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $media): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div> 
                                                <img src="<?php echo e($media->getUrl()); ?>" alt="Imagem do Produto" style="width:100px; height:100px;">
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="detail-info pr-30 pl-30">
                                    ...
                                    <?php
                                        ...
                                        <?php if($product->discount_price === NULL || $product->discount_price == 0): ?>                                        <div class="product-price primary-color float-left">
...
<?php endif; ?>
    ...
    value="1" 
    min="1" 
    max="<?php echo e($product->product_qty); ?>" 
    oninput="checkMaxValue(this)"
>
                                            <a href="#" class="qty-up"><i class="fi-rs-angle-small-up"></i></a>
                                        </div>
                                        <div class="product-extra-link2">
                                            <button type="submit" class="button button-add-to-cart"><i class="fi-rs-shopping-cart"></i>Adcionar ao carrinho</button>
...
<ul class="mr-50 float-start">
    ...
    <ul class="float-start">
        ...
        <li>Estoque:<span class="in-stock text-brand ml-5"><?php echo e($product->product_qty); ?> item no estoque</span></li>
    </ul>
</div>
                                </div>
                                <!-- Detail Info -->
                                ...
                                <div class="tab-content shop_info_tab entry-main-content">
                                    ...
                                    <div class="tab-pane fade" id="Vendor-info">
                                        <div class="vendor-logo d-flex mb-30">
                                            <img src="<?php echo e((!empty($product->vendor->photo)) ? url('upload/vendor_images/'.$product->vendor->photo):url('upload/no_image.jpg')); ?>" alt="" />
    ...
    <?php endif; ?>
                                        ...
                                        <ul class="contact-infor mb-50">
                                            <li><img src="<?php echo e(asset('frontend/assets/imgs/theme/icons/icon-location.svg')); ?>" alt="" /><strong>Enderenco: </strong> <span>Proprietario</span></li>
                                            <li><img src="<?php echo e(asset('frontend/assets/imgs/theme/icons/icon-contact.svg')); ?>" alt="" /><strong>Contacto:</strong><span>Proprietario</span></li>
                                        </ul>
                                            <?php else: ?>
                                            <ul class="contact-infor mb-50">
                                            <li><img src="<?php echo e(asset('frontend/assets/imgs/theme/icons/icon-location.svg')); ?>" alt="" /><strong>Enderenco: </strong> <span></span></li>
                                            <li><img src="<?php echo e(asset('frontend/assets/imgs/theme/icons/icon-contact.svg')); ?>" alt="" /><strong>Contacto:</strong><span></span></li>
                                        </ul>
                                            <?php endif; ?>
                    ...
                    <div class="product-cart-wrap hover-up">
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                                <a href="<?php echo e(url('product/details/'.$product->id.'/'.$product->product_slug)); ?>" tabindex="0">
...
<?php endif; ?>                                
                        ...
                        <div class="product-content-wrap">
                            <h2><a href="<?php echo e(url('product/details/'.$product->id.'/'.$product->product_slug)); ?>" tabindex="0"><?php echo e($product->product_name); ?></a></h2>
...
<?php echo $__env->make('frontend.master_dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Cuata\laravel10\resources\views/frontend/product/product_details.blade.php ENDPATH**/ ?>