                            ...
                            <div class="col-md-3">
                                <div class="dashboard-menu">
                                    <ul class="nav flex-column" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="<?php echo e(route ('user.logout')); ?>"><i class="fi-rs-sign-out mr-10"></i>Sair</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                    ...
                                    <div class="tab-pane fade active show" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="mb-0">Oi <?php echo e(Auth::user()->name); ?></h3></br>
                                                <img id="showImage" src="<?php echo e((!empty($userData->photo)) ? url('upload/user_images/'.$userData->photo):url('upload/no_image.jpg')); ?>" alt="User" class="rounded-circle p-1 bg-primary"  style="width:100px; height:100px">
                            ...
                            <div class="tab-pane fade" id="account-detail" role="tabpanel" aria-labelledby="account-detail-tab">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input required="" class="form-control" name="username" type="text" value="<?php echo e($userData->username); ?>"/>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>Nome completo <span class="required" >*</span></label>
                                        <input required="" class="form-control" name="name" value="<?php echo e($userData->name); ?>" />
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label>Numero de Celular <span class="required">*</span></label>
                                        <input required="" class="form-control" name="phone" type="text" value="<?php echo e($userData->phone); ?>" />
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label>Endereco do Email<span class="required">*</span></label>
                                        <input required="" class="form-control" name="email" type="email" value="<?php echo e($userData->email); ?>" />
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label>Endereco do Usuario <span class="required">*</span></label>
                                        <input required="" class="form-control" name="address" type="text" value="<?php echo e($userData->address); ?>" />
                                    </div> 
                                    <div class="form-group col-md-12">
...
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Cuata\Desktop\starshop\resources\views/index.blade.php ENDPATH**/ ?>