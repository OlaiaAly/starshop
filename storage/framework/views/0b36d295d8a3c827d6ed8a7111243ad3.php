                        ...
                        <div class="header-action-right">
                            <div class="header-action-2">
                                ...
                                <div class="header-action-icon-2">
                                    ...
                                    <a href="<?php echo e(route('openCard')); ?>"><span class="lable">Carrinhos</span></a>
                                    <?php
                                        $user = auth()->user();
                                        if ($user) {
                                    ...
                                    <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                        ...
                                        <?php if($cart && $cart->items->count() > 0): ?>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="shopping-cart-title">
                                                        <h4><a href="shop-product-right.html"><?php echo e(ucwords( $item->itemable->product_name)); ?></a></h4>
                                                        <h4><span><?php echo e($item->quantity); ?> × </span><?php echo e(number_format($item->subtotal, 2, '.', ' ') . ' MZN'); ?>
                                        ...
                                        <div class="shopping-cart-footer">
                                            <div class="shopping-cart-total">
                                                <h4>Total <span><?php echo e(number_format($cart->total, 2, '.', ' ') . ' MZN'); ?></span></h4>
                                            </div>
                                            <div class="shopping-cart-button">
                                                <a href="<?php echo e(route('openCard')); ?>" class="outline">View cart</a>
                                                <a href="<?php echo e(route('openCard')); ?>">Checkout</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<a href="<?php echo e(route('dashboard')); ?>"><span class="lable ml-0"> <?php echo e(Auth::user()->name); ?> </span></a>
                                    <div class="cart-dropdown-wrap cart-dropdown-hm2 account-dropdown">
                                        <ul>
                                            ...
                                            <li>
                                                <a href="<?php echo e(route('get.orders')); ?>"><i class="fi fi-rs-label mr-10"></i>Meus Pedidos</a>
                                            </li>
                                            <li>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                        
                                        ...
                                        <?php if($cart): ?>
                                            ...
                                            <li>
                                                ...
                                                <div class="shopping-cart-title">
                                                    ...
                                                    <h3><span><?php echo e($cart->quantity); ?> × </span><?php echo e($cart->price); ?></h3>
                                                </div>
                                                <div class="shopping-cart-delete">
                                                    <a href="#"><i class="fi-rs-cross-small"></i></a>
                                                </div>
    ...
    </header><?php /**PATH C:\Users\Cuata\Desktop\ALY\starshop\resources\views/frontend/body/header.blade.php ENDPATH**/ ?>