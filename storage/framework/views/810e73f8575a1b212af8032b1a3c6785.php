...
<div class="page-content">
    ...
    <div class="card">
        <div class="card-body p-4">
            ...
            <form method="post" id="myForm" action="<?php echo e(route('store.product')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<script type="text/javascript"> 
    $(document).ready(function() {
        ...
        $.validator.addMethod("discountPriceValidation", function(value, element) {
            const sellingPrice = parseFloat($("input[name='selling_price']").val()) || 0;
            const discountPrice = parseFloat(value) || 0;
            return discountPrice < sellingPrice; // O preço com desconto deve ser menor que o preço
        ...
        $("#myForm").validate({
            rules: {
                ...
                discount_price: {
                    required: true,
                    number: true,
                    discountPriceValidation: true // Adiciona a validação personalizada aqui
                },
                product_qty: {
                    required: true,
                    digits: true
            ...
            messages: {
                ...
                discount_price: {
                    required: "Por favor, insira o preço com desconto",
                    number: "Por favor, insira um valor numérico válido",
                    discountPriceValidation: "O preço com desconto deve ser menor que o preço original."
                },
                product_qty: {
...
<?php echo $__env->make('admin.admin_dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Cuata\laravel10\resources\views/backend/product/product_add.blade.php ENDPATH**/ ?>