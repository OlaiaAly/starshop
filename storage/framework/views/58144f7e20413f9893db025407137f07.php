				...
				<div class="container">
					<div class="main-body">
						<div class="row">
							...
							<div class="col-lg-10">
								<div class="card">
                                    <form method="post" id="myForm" action="<?php echo e(route('store.category')); ?>" enctype="multipart/form-data">
                                        <?php echo csrf_field(); ?>
									...
									<div class="card-body">
                                        ...
                                        <div class="row mb-3">
											...
											<div class="col-sm-9 text-secondary">
                                            <img id="showImage" src="<?php echo e(url('upload/no_image.jpg')); ?>" alt="Admin"  style="width:100px; height:100px">
...
<?php echo $__env->make('admin.admin_dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Cuata\Desktop\laravel10\resources\views/backend/category/category_add.blade.php ENDPATH**/ ?>