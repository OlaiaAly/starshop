                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-10 col-md-12 m-auto">
                        <div class="row">
                            ...
                            <img class="border-radius-15" src="/frontend/assets/imgs/page/2103.jpg" alt="" style="width: 850px; height: 425px;">                            </div>
                            <div class="col-lg-6 col-md-8">
                                <div class="login_wrap widget-taber-content background-white">
                                    <div class="padding_eight_all bg-white">
                                        <div class="heading_s1">
                                            <h1 class="mb-5">Login</h1>
                                            <p class="mb-30">Ainda não tens uma conta ? <a href="<?php echo e(route('register')); ?>">Clique Aqui Para Criar</a></p>
                                        </div>
                                        <form method="POST" action="<?php echo e(route('login')); ?>">
                                             <?php echo csrf_field(); ?>
                                            <div class="form-group">
                                                <input type="email" id="email" required="" name="email" placeholder="Username ou Email *" />
                                            </div>
                                            <div class="form-group">
                                                <input required="" type="password" id="password" name="password" placeholder="Insira Sua Senha *" />
                                            </div>
                                            ...
                                            <div class="login_footer form-group mb-50">
                                                ...
                                                <a class="text-muted" href="<?php echo e(route('password.request')); ?>">Esqueceu a Senha?</a>
                                            </div>
                                            <div class="form-group">
...
</html><?php /**PATH C:\Users\Cuata\Desktop\starshop\resources\views/auth/login.blade.php ENDPATH**/ ?>