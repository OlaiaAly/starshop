    ...
    <div class="container">
        <div class="section-title style-2 wow animate__animated animate__fadeIn">
            ...
            <ul class="nav nav-tabs links" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="nav-tab-two" href="#category<?php echo e($category->id); ?>" data-bs-toggle="tab"
                        data-bs-target="#tab-two" type="button" role="tab" aria-controls="tab-two"
                        aria-selected="false"><?php echo e($category->category_name); ?></a>
                </li>
                        ...
                        <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
                            <div class="product-img-action-wrap">
                                <div class="product-img product-img-zoom">
                                    <a href="<?php echo e(url('product/details/'.$product->id.'/'.$product->product_slug)); ?>">
                                        ...
                                        <?php else: ?>
                                        <img src="<?php echo e(asset('upload/no_image.jpg')); ?>" style="width:400px; height:200px;"
                                ...
                                <div class="product-action-1">
                                    ...
                                    <a aria-label="Quick view" class="action-btn" data-bs-toggle="modal"
                                        data-bs-target="#quickViewModal" id="<?php echo e($product->id); ?>"
                                ...
                                <div class="product-badges product-badges-position product-badges-mrg">
                                    <?php if($product->discount_price === NULL || $product->discount_price == 0): ?> <span
                                        class="new">Novo</span>
                            ...
                            <div class="product-content-wrap">
                                <div class="product-category">
                                    <a
                                        href="shop-grid-right.html"><?php echo e($product['category']['category_name'] ?? 'Categoria não disponível'); ?></a>
                                </div>
                                <h2><a
                                        href="<?php echo e(url('product/details/'.$product->id.'/'.$product->product_slug)); ?>"><?php echo e($product->product_name); ?></a>
                                </h2>
                                ...
                                <div class="product-card-bottom">
                                    ...
                                    <div class="add-cart">
                                        <a class="add"
                                            href="<?php echo e(route('product.details', ['id' => $product->id, 'slug' => 0 ])); ?>"><i
                            ...
                            <div class="product-content-wrap">
                                ...
                                <div>
                                    ...
                                    <span class="font-small text-muted">By <a
                                            href="vendor-details-1.html"><?php echo e($product['vendor']['name']); ?></a></span>
                                ...
                                <div class="product-card-bottom">
                                    ...
                                    <div class="add-cart">
                                        <a class="add" href="<?php echo e(route('product.details', ['id' => $product->id, 'slug' => 0 ])); ?>"><i
                                                class="fi-rs-shopping-cart mr-5"></i>Adcionar</a>
                                    </div>
                                </div>
                            </div>
...
</section><?php /**PATH C:\Users\Cuata\Desktop\ALY\starshop\resources\views/frontend/home/home_new_product.blade.php ENDPATH**/ ?>